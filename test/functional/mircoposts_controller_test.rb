...
class MircopostsControllerTest < ActionController::TestCase
  ...
  test "should create mircopost" do
    assert_difference('Mircopost.count') do
      post :create, mircopost: { active_record: @mircopost.active_record, content: @mircopost.content, invoke: @mircopost.invoke, user_id: @mircopost.user_id }
    end
  ...
  test "should update mircopost" do
    put :update, id: @mircopost, mircopost: { active_record: @mircopost.active_record, content: @mircopost.content, invoke: @mircopost.invoke, user_id: @mircopost.user_id }
    assert_redirected_to mircopost_path(assigns(:mircopost))
  end
